  ...
  spar: [
    ...
    },
    {
      ...
      estimatedValue: 100.00,
        ...
        {
      name: 'Grocery - Value Bag',
      description: 'A variety of Cereals, Canned Goods, Sweets, Rice, Sugar and other mixed groceries. Contents vary, but quality is still good. Images are for illustration only—actual contents may vary.',
      retailPrice: 49.95,
      estimatedValue: 100.00,
    },
  ],
