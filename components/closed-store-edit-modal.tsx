...
import { Plus, Trash2, Upload, FileText, Users, X, Copy } from "lucide-react"
...
import { formatDateTime, formatDateTimeForDisplay, formatDateTimeForInput, parseDateTime } from "./utils"
...
${products.map(product => `**${product.name} - Retail R${product.retailPrice} / Estimated R${product.estimatedValue}**\n${product.description || 'N/A'}`).join('\n\n')}
