...
const navigationItems = [
  {
    ...
    url: "/leads",
    icon: Building2,
    roles: ["superadmin", "salesperson", "ops", "media"],
  },
    {
    title: "Closed",
    url: "/closed",
  ...
  },
  {
    ...
    url: "/errors",
    icon: AlertTriangle,
    roles: ["superadmin", "ops", "salesperson"],
  },
  {
      ...
      <SidebarHeader className="border-b px-2 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            {!isCollapsed && <div className=" w-8 h-8 bg-[#ff5900] rounded-lg flex items-center justify-center flex-shrink-0">
              <Building2 className="w-4 h-4 text-white" />
            </div>}
            {!isCollapsed && (
              <div>
                <h2 className="font-semibold text-gray-900">Still Good</h2>
