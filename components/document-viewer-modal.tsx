...
//   const documentInfo = documentType === "sla" ? store.slaDocument : store.bankDocument
//   const isUploaded = documentType === "sla" ? store.signedSla : store.bankConfirmation

//   const documentTitle = documentType === "sla" ? "Service Level Agreement" : "Bank Confirmation"
...
//                     <div>
//                       <span className="font-medium">Uploaded:</span>
//                       <p className="text-gray-600">{new Date(documentInfo.uploadedAt).toLocaleDateString()}</p>
//                     </div>
//                     <div>
//                       <span className="font-medium">Uploaded By:</span>
//                       <p className="text-gray-600">{documentInfo.uploadedBy}</p>
...
//                   <p className="text-gray-600 mb-4">The {documentTitle.toLowerCase()} has not been uploaded yet.</p>
