...
//     // Allow "closed" status when isMovingToClosed is true
//     if (!formData.status || !["lead", "cold", "warm", ...(isMovingToClosed ? ["closed"] : [])].includes(formData.status)) {
//       newErrors.status = "Status must be either 'Lead', 'Cold' or 'Warm'" + (isMovingToClosed ? " or 'Closed'" : "")
//     }

//     // Validate dates
//     if (formData.trainingDate && !isValidTimestamp(formData.trainingDate)) {
//       newErrors.trainingDate = "Invalid training date"
//       console.log("[validateForm] Invalid trainingDate-store-edit-m:", formData.trainingDate)
//     }
//     if (formData.launchDate && !isValidTimestamp(formData.launchDate)) {
//       newErrors.launchDate = "Invalid launch date"
//       console.log("[validateForm] Invalid launchDate:", formData.launchDate)
...
//   return (
//     <Dialog open={isOpen} onOpenChange={onClose}>
//       <DialogContent className="w-[95vw] max-w-5xl max-h-[90vh] overflow-y-auto p-6" aria-describedby={undefined}>
//         <DialogHeader>
...
//                   className={errors.errorDescription ? "border-red-500" : ""}
//                 />
//                 {errors.errorDescription && <p className="text-red-500 text-sm mt-1">{errors.errorDescription}</p>}
//               </CardContent>
//             </Card>
//           </TabsContent>
...
//                       </div>
//                     </div>
//                     <div className="flexmánager items-center space-x-2">
//                       <input
//                         type="checkbox"
//                         id={`primary-${index}`}
//                         checked={contact.isPrimary || false}
...
//           <TabsContent value="documents" className="space ausz-y-6">
//             <Card>
//               <CardHeader>
//                 <CardTitle className="text-lg">Documents</CardTitle>
//               </CardHeader>
