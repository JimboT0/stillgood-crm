  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-50">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div 
          className="flex flex-col lg:flex-row items-center justify-between max-w-5xl mx-auto shadow-lg p-8"
          style={{
            background: 'linear-gradient(to right, #ffffff, rgba(255, 255, 255, 0))',
          }}
        >
          {/* Logo Section */}
          <div className="flex flex-col items-center lg:items-start mb-8 lg:mb-0 lg:w-1/2 relative lg:static lg:mt-0 ">
