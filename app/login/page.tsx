...
function SGlogocrm() {
  return <img src={sglogocrm.src} alt="Still Good CRM" className="w-50 h-50" />;
}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col items-center lg:items-start mb-8 lg:mb-0 lg:w-1/2 relative lg:static -mt-[30%] lg:mt-0 ">
            <div className="w-40 h-40 flex items-center mb-1">
              <SGlogocrm />
            </div>
            ...
            <form onSubmit={handleSignIn} className="space-y-6">
              ...
              <div className="text-sm text-right">
                <button
                  ...
                  className="text-[#ff5900] hover:underline focus:outline-none"
